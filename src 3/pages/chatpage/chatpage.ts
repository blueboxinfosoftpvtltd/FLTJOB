...
export class ChatpagePage {
  ...
  constructor(public navCtrl: NavController, private toastCtrl: ToastController, public navParams: NavParams, public provider: AuthproviderProvider, public storage: Storage, private keyboard : Keyboard,
    private camera: Camera, private transfer: Transfer,public events:Events, private modal: ModalController, private file: File, private filePath: FilePath, public actionSheetCtrl: ActionSheetController, public platform: Platform, public socket: Socket,public app : App) {
      platform.ready().then(() => {
