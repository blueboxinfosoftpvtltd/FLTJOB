...
export class FilterflightattendantPage {
  ...
  filter() {
    ...
    this.provider.filterflightattendant(this.id, this.exp, this.havepasssport, this.continents, this.aircraftspecifitraining, this.language, this.showprofile, this.tripid, this.rate, this.ratingcount,this.isnearest,this.favattendant,1).subscribe(res => {
      console.log(res);
