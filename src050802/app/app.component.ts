          ...
          if (this.res.data != null) {
             ...
             // this.provider.dismissloading();
              ...
              if (this.res.data.Pilot.MemberShipType == "" || this.res.data.Pilot.MemberShipType == 0) {
                //this.loading.dismiss();
                this.app.getRootNav().setRoot("TabpagePage", { tabIndex: 1, 'istab': 'google',"data": this.res, 'usertype': this.res.data.Pilot.MemberShipType }, { animate: false }).then(() => {
                    this.events.publish('available', this.res.data.Pilot.Availability);
                    splashScreen.hide();
                })
              }
                ...
                //this.loading.dismiss();
                this.app.getRootNav().setRoot("TabpagePage", { tabIndex: 0, 'istab': 'google',"data": this.res, 'usertype': this.res.data.Pilot.MemberShipType }, { animate: false }).then(() => {
                    this.events.publish('available', this.res.data.Pilot.Availability);
                    splashScreen.hide();
                })
              }
            ...
            // this.showAlert();
                ...
                //         this.provider.settoken(token.value);
