...
export class AuthproviderProvider {
  ...
  updateowenerop(id, fname, lname, location, country, memberid, cname, photo, gender) {
    let updateowener = {
      "pkPilotId": id,
      "PilotFname": fname,
      "PilotLname": lname,
  ...
  updateinstructor(id, fname, lname, memberid, phno, totaltime, timeofinstruct, mclass, mdate, aircraftid, avionicsid, passfail, instrumentins, mutliengineins, complextime, highperformtime, tailwheelinsructor, acroinstructor, dpdrate, dphrate, ipdrate, iphrate, photo, pictime, gender) {
    let updateins = {
      "pkPilotId": id,
      "PilotFname": fname,
      "PilotLname": lname,
  ...
  updatepilot(id, fname, lname, nname, location, country, memberid, phno, ttime, mclass, mdate, passport, passportno, passportexpirydate, citizencountry, exptype, continents, oceans, aircraft, avionics, notes, ms, photo, pictime, gender) {
    let updatepil = {
      "pkPilotId": id,
      "PilotGender": gender,
      "PilotFname": fname,
  ...
  updateflightatt(id, memberid, fname, lname, regionexp, unrestricteduspass, ivisa, cprtraining, aircraft, cullinarytraining, language, continents, specialtrained, req12omonths, exp, passport, aircraftspecifictraining, dpdrate, ipdrate, photo, phno, gender, airtrainexp, selectedcullinarytraining, cullinaryothertraining, selectedtraining, othertraining, selectedregion) {
    let updatepil = {
      "pkPilotId": id,
      "fkMemberShipId": memberid,
      "PilotFname": fname,
      ...
      "Cullinary": selectedcullinarytraining,
      "CullinaryOther": cullinaryothertraining,
      "SpecialTrained": selectedtraining,
      "SpecialTrainedOther": othertraining,
      "RegionExp": selectedregion
    }
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
  ...
  join(fname, lname, mname, clocation, country, mid, email, oldpass, newpass, devicetype, cname, gender) {
    console.log(gender);
    if (gender == "Male") {
      this.photopath = "http://www.blueboxinfosoft.com/apps/momentshare/uploads/user-silhouette.png";
    } else if (gender == "Female") {
      this.photopath = "http://www.blueboxinfosoft.com/apps/momentshare/uploads/woman-avatar.png";
    } else {
      this.photopath = "http://www.blueboxinfosoft.com/apps/momentshare/uploads/20190102115342IMG_20190102_171849_18373576074998577.jpg"
    }
    let joindata = {
      "PilotFname": fname,
      "PilotLname": lname,
  ...
  getfavuser(id) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + '/GetFavourite', data, { headers: header });
  }
  ...
  setmasterdata(value) {
    ...
    this.traindata = this.masterdata.data.AirCraft;
  }
  getmasterdata() {
  ...
  uploadfaimages(pilotid, index, f1, f2, f3, f4, f5, f6) {
    if (f1 == undefined || f1 == null || f1 == "") {
      f1 = "";
    }
    if (f2 == undefined || f2 == null || f2 == "") {
      f2 = "";
    }
    if (f3 == undefined || f3 == null || f3 == "") {
      f3 = "";
    }
    if (f4 == undefined || f4 == null || f4 == "") {
      f4 = "";
    }
    if (f5 == undefined || f5 == null || f5 == "") {
      f5 = "";
    }
    if (f6 == undefined || f6 == null || f6 == "") {
      f6 = "";
    }
    let data = {
      "pkPilotId": pilotid,
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/InsertFlightAttendantImage", data, { headers: header });
  }
  ...
  gettrip(tripid, lid) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/getfilteredpilot", completetripdata, { headers: header });
  }
  ...
  getstrip(tripid, lid) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/getfilteredSIC", completetripdata, { headers: header });
  }
  ...
  getitrip(tripid, lid) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/getfilteredINS", completetripdata, { headers: header });
  }
  ...
  getftrip(tripid, lid) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/getfilteredATT", completetripdata, { headers: header });
  }

  removenotification(pid, nid) {
    let completetripdata = {
      "fkPilotId": pid,
      "pkNotifyId": nid
    }
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/RemoveNotification", completetripdata, { headers: header });
  }
  ...
  removefav(uid, pid) {
    ...
    let header = new HttpHeaders();
    header.append('Content-Type', 'application/json');
    return this.http.post(this.url + "/RemoveFavourite", completetripdata, { headers: header });
  }
