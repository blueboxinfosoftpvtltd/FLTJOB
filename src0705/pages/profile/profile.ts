...
export class ProfilePage {
  ...
  constructor(private toastCtrl: ToastController, public navCtrl: NavController, public navParams: NavParams, private selector: WheelSelector, public events: Events, public provider: AuthproviderProvider, public app: App, public sharedservice: SharedserviceProvider, public alertCtrl: AlertController, public storage: Storage,public actionSheetCtrl: ActionSheetController, public platform: Platform, public file: File, public filePath: FilePath,private modalCtrl: ModalController) {
    ...
    // for(let i = 0 ;i<this.masterdata.data.AirCraft.length;i++){
    //   this.trainaircraftdata.push(this.masterdata.data.AirCraft[i]);
    // }
    // console.log(this.trainaircraftdata);
        ...
        this.provider.getContinents().subscribe(res => {
          ...
          if (this.airexp != undefined) {
           ...
           // console.log(this.aircraftdata);
            // this.aircraftdata.filter(function (e1, i) {
            //     e1.checked = false;
            //     //  if (this.airexp.indexOf(e1.AircraftType) != -1) {
            //     //   e1.checked = true;
            //     //  }
            // });


            // this.aircraftdata.forEach(element => {
            //   element.checked = false;
            //   if (this.airexp.indexOf(element.AircraftType) != -1) {
            ...
            //setTimeout(() => {
              this.sharedservice.getaircraftchklist(this.aircraftdata, this.airexp);
            //console.log(this.masterdata.data.AirCraft);
           // }, 2000);
...
//                       //this["captureDataUrl"+val] = base64File;
//                       //this.captureDataUrl1 = base64File;
...
//                         }
//                       this.provider.setloading();
//                       this.provider.uploadfaimages(this.userdata.data.Pilot.pkPilotId,val,f1,f2,f3,f4,f5).subscribe(res => {
//                         console.log(res);
//                         this.fapic = res;
//                         console.log(res);
//                         if(val == 1){
...
ngAfetrViewInit(){
  // GalleryModal.prototype.remove().then(res =>{
  //   console.log(res);
  // })
}
