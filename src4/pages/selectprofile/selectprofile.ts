...
export class SelectprofilePage {
  ...
  totalcount: any;
  languagedata: any;
  constructor(public navCtrl: NavController, public navParams: NavParams, public events: Events, public view: ViewController, public alertCtrl: AlertController,public storage : Storage) {
