...
export class ProfilePage {
      ...
      // for Flight Attendant data
        ...
        this.provider.getContinents().subscribe(res => {
          ...
          if (this.airtrainexp != undefined) {
            this.sharedservice.getaircraftchklist(this.aircraftdata, "");
          }
  ...
  updatedata() {
    ...
    if (this.type == 'Owner Operator') {
      ...
      this.provider.updateowenerop(this.userdata.data.Pilot.pkPilotId, this.fname, this.lname, location, this.countryname, fkid, this.cname, this.photo).subscribe(res => {
        this.response = res;
    ...
    // For Pilot and SIC update data
      ...
      // this.storage.get('country').then(val => {
        ...
        this.countryname = localStorage.getItem("country");
        console.log(this.countryname)
      this.provider.updatepilot(this.userdata.data.Pilot.pkPilotId, this.fname, this.lname, "", location, this.countryname , fkid, this.phoneno, this.ttime, this.medicalclass, "", passport, "", this.passportexpdate, this.country, this.expid, this.selectedcontinents, this.selectedociens, this.airexp, this.avionicsexpid, this.msg, this.simulatortraining, this.photo,this.pictime).subscribe(res => {
        this.response = res;
        if (this.response.Code == 200) {
          if (this.response.data != null) {
            this.provider.dismissloading();
  ...
  selecttrainaircraft(){
    this.app.getRootNav().push('SelectaircraftPage', { 'selectedaircraft': "", 'type': 'trainaircraft', animate: false });
  }
