...
import { IonicPage, NavController, NavParams, ToastController, AlertController, ActionSheetController, Platform, Navbar } from 'ionic-angular';
...
export class ChatpagePage {
  ...
  constructor(public navCtrl: NavController, private toastCtrl: ToastController, public navParams: NavParams, public provider: AuthproviderProvider, public storage: Storage,
    private camera: Camera, private transfer: Transfer,public events:Events, private modal: ModalController, private file: File, private filePath: FilePath, public actionSheetCtrl: ActionSheetController, public platform: Platform, public socket: Socket) {
  ...
  sendNewMsg(SendMessage) {
    ...
    this.provider.setloading();
    if (SendMessage == undefined || SendMessage == '' || SendMessage == null) {
      this.provider.dismissloading();
